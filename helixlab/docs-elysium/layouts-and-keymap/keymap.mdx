...
<Tabs queryString="pcb-variant">
  <TabItem value="hotswap" label="热插拔" default>
    ...
    ![](./img/elysium_keycodes_l1_103.svg)
...
<Icon icon="fa-solid fa-square" style={{color: "#269ED3",}} /> 是`全键无冲键`，用于在六键无冲和全键无冲之间切换，详见[全键无冲](/docs-elysium/miscellaneous/nkro?pcb-variant=hotswap)页面。
