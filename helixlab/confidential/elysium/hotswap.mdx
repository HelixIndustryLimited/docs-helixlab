...
| <Icon icon="fa-brands fa-bluetooth" /> 无线模块-Nordic nRF52840 | <Icon icon="fa-solid fa-microchip" /> 主控-ST STM32L433 | 备注 | 版本 |
|---|---| --- | --- |
| | | |

## 烧录无线模块固件 {#flash-wireless-module-firmware}
