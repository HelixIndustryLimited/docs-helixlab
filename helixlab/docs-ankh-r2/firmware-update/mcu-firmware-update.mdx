...
固件更新后，键盘上存储的个人设置将被全部还原为初始状态，例如 RGB 矩阵设置、VIA 自定义设置等。
...
<Icon icon="fa-solid fa-hashtag" style={{color: "#cc9e75",}} /> <Icon icon="fa-solid fa-1" style={{color: "#cc9e75",}} />  从 [固件](/docs-ankh-r2/downloads/firmware) 页面下载固件。
...
<Icon icon="fa-solid fa-hashtag" style={{color: "#cc9e75",}} /> <Icon icon="fa-solid fa-4" style={{color: "#cc9e75",}} /> 关闭电池开关 <sup>[<Icon icon="fa-solid fa-compass" /> 怎么做？](/docs-ankh-r2/battery/battery-switch)</sup>，断开 USB 数据线，然后按住 <kbd>**backspace**</kbd> 的同时插入 USB 数据线。
