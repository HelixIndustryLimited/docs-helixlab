...
Ankh 具有 RGB 灯光矩阵，你可以在四十余种左右的灯效中随意切换，同时自定义亮灭、色相、饱和度以及亮度等参数。 

## RGB 矩阵控制按键 {#rgb-matrix-keys}

下图所示的青绿色按键用于控制 RGB 矩阵。

![](./img/ankh_keycodes_rgb.svg)

* <kbd>**.**</kbd> + <kbd>**1**</kbd> 打开或关闭 RGB 矩阵。

* <kbd>**.**</kbd> + <kbd>**2**</kbd> 切换至下一种灯效。

* <kbd>**.**</kbd> + <kbd>**3**</kbd> 偏移色相。
